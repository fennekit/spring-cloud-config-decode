...
public class AesTextEncryptionTests
{
    ...
    public void ExceptionTestForSpringConfigCipher(string salt, string key, string cipher)
    {
        var textDecryptor = new AesTextDecryptor(key, salt);
        Assert.Throws(typeof(DecryptException), () => textDecryptor.Decrypt(cipher));
    }
    ...
    private static IEnumerable<object[]> GetExceptionVector()
    {
        ...
        [
            "deadbeef",
            "12345678901234567890",
            "23f97efeed4ab62294432e8ef6b2905e",
        ];
        yield return
        [
            "deadbeef",
            "12345678901234567890",
            "23f97efeed4ab62294432e8ef6b2905e336c245ecb1d5122b2c288c4deeae1b737952312e97e2cf013dd31a28fc607",
        ];
    }
